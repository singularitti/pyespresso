...
SYSTEM: set = {
    'ibrav', 'celldm(1)', 'celldm(2)', 'celldm(3)', 'celldm(4)', 'celldm(5)', 'celldm(6)' 'A', 'B', 'C', 'cosAB',
...
# Transform sets into lists for zipping process
CONTROL_namelist = list(CONTROL)
SYSTEM_namelist = list(SYSTEM)
ELECTRONS_namelist = list(ELECTRONS)
IONS_namelist = list(IONS)
CELL_namelist = list(CELL)
