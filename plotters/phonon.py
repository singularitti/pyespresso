...
class PhononPlotData:
    ...
    def generate_plotting_data(self, filename: str, density: IntArray):
        """
        I write this method because I want to separate data generation and plot steps.
    ...
    def plot_dos(self, filename: Optional[str] = 'matdyn.dos.out', freq_unit: Optional[str] = 'ev',
        ...
        if mode == 'preview':
            ...
            raise ValueError('Unknown read_file mode!')
...
class PlotPhononDispersionRelation(PhononPlotData):
    def dispersion_relation(self, data, color: Optional[str] = 'g', option: Optional[str] = 'hz'):
        """
        This method is used to plot a phonon dispersion relation for one read_file given by matdyn.x.

        :param data: This data is generated by `generate_plotting_data`.
        :param color: Color for the manifold. The default value is green.
        :param option: Specify energy unit, you can submit 'hz' for hertz, 'thz' for tera-hertz, 'ev' for electron-volt.
        ...
        # Main plot code block
        for i, ax in enumerate(axes):
            x_coordinates = range(len(qs[i]))  # Remap q-points coordinates to x coordinates for plot
