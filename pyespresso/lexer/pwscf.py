...
class PWscfOutputLexer(SimpleLexer):
    ...
    def lex_total_stress(self, unit: Optional[str] = 'atomic') -> np.ndarray:
        """
        Read the total stress, in 2 units, from pyespresso.the bottom of the output file.
    ...
    def lex_k_coordinates(self, out_file: str, coordinate_system: Optional[str] = 'crystal'):
        """
        This method can be used to read how many k-points are involved in a PWscf calculation from pyespresso.a file
